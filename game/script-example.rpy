## Script-Example.rpy
# This is the script that runs at the beginning of the template
# This also references stuff that are coded in comments as well
...
label example_chapter:
    ...
    m "Welcome to the modification club!"
    show monika 3 zorder 2 at t11
    m "I started this club after I had some difficulties changing code in the original game."
    ...
    m 2b "You can find the source for it online at https://github.com/GanstaKingofSA/DDLCModTemplate2.0/releases"
    ...
    m 2a "That's at https://www.renpy.org/release/6.99.12"
    ...
    if experience_level > 0:
        m 2a "Since you've coded before, you might like to know that this game was built using Ren'Py."
        m "It's a very popular platform for making visual novels."
        show monika 1a zorder 2 at t11
        menu:
            m "Have you used Ren'Py before?"
            "Yes.":
                $ knows_renpy = True
                m 1b "Sounds like you're ahead of the game, then."
            "No.":
                m 1e "Well, don't worry about that."
                m 1b "Ren'Py is actually very easy once you get used to it."
        m 3a "For more advanced coding, Python might be necessary."
        m 3c "Ren'Py is actually built with Python..."
        ...
        menu:
            ...
            "Yes.":
                $ knows_python = True
                if not knows_renpy:
                    m 1a "That might help you pick up Ren'Py a little quicker, then."
                    m 3a "But there are some things that makes Ren'Py's Python a bit different."
            ...
            "No.":
                if not knows_renpy:
                    ...
                    m 2a "I'm sure you picked up a few tricks from Ren'Py already."
    ...
    menu:
        ...
        "Advanced.":
            ...
            "Please note that the Advanced Section of the template is the old template advanced section."
            "This may not be accurate to what the template is now. A new version will be released soon."
