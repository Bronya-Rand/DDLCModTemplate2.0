...
label tutorial_route_p1:
    ...
    m "First of all, I suggest you get a programming application."
    m "Ren'Py's built-in one...sucks..."
    m "I recommend Visual Studio Code to code your mod. It's available on Windows, Mac and Linux."
    m "Download Visual Studio Code from here: https://code.visualstudio.com/download and install it."
    ...
    m "If not you will get a error and will have to add more spaces or less spaces."
    m "Now open the file you made."
    m "In it type without quotes \nlabel Chapter1:"
    m "Press enter, and type \"return\" without quotes."
    m "Afterwards go to File in Visual Studio Code and click Save."
...
label tutorial_route_p2:
    ...
    m 2a "Check that all lines below 'label monika_route:' are aligned and that 'return' is the last line."
