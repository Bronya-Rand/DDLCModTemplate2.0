...
label tutorial_route_p1:
    ...
    m 1a "Of course, as both you and I are new at programming, we should keep it simple."
    m 1h "We’ll need Ren’Py, but unfortunately I can’t access it from here."
    m 3a "So, I’m counting on you to help me."
    m 4a "Make sure you follow my instructions exactly, okay? In coding, a single mistake can totally break a program."
