...
label tutorial_route_p1:
    ...
    m "Making a mod for the first time requires that you get a idea to write down."
    ...
    m "Ren'Py's recommended built-in one...sucks..."
    m "I recommend Visual Studio Code (VSC) to code your mod. It's available on Windows, Mac and Linux via \"code.visualstudio.com/download\"."
    m "Alternatively, if you want something on the go or lighter, you can use Notepad ++ from \"notepad-plus-plus.org/downloads/\"."
    ...
    menu:
        ...
        "Visual Studio Code":
            ...
            m "Click it and search \"Renpy\" without quotes and click the green install button below the result."
            m "Afterwards, go to File and click Open Folder, then find the \"renpy-6.99.12.4-sdk\" folder, double-click it and click the \"game\" folder once. Afterwards, click Open."
    ...
    if vsc == True:
        ...
        m "Now name the file Chapter1 but do add .\"rpy\" without quotes at the end and hit enter."
        m "It should look like this. \nchapter1.rpy"
    else:
        m "Go into your Ren'Py Launcher and click Navigate Script."
        m "Then scroll all the way down in the files tab till you see \"+ Add Script File\"."
        m "Click that and name your file \"chapter1\"."
    m "Now open \"script.rpy\" and go down to Lines 42-45 and replace them with \"call Chapter1\"."
    ...
    m "Do not press the tab button if you are not using Visual Studio because Ren'Py hates it. VSC automatically changes them to spaces."
    m "Now open the file you made with either VSC or your chosen program."
    m "In it type without quotes \nlabel Chapter1:"
    m "Press enter, hit space 4 times and type \"return\" without quotes."
    ...
    m "If you get a error, try replaying this lesson to see what you did wrong."
    m "That's all for this section! When you are ready, begin the second part! I'll be waiting!"
    m "Don't exit the game though. You got a bit more coding to do before you see the end result."
    return
...
label tutorial_route_p2:
    ...
    m 4a "First open chapter1.rpy."
    m "Between the first line and 'return', add 4 spaces then the line \"stop music fadeout 2.0\" without quotes."
    m "Then add the line \"play music t2'\"."
    m "Finally, add the line \"mc 'Let's listen to the music.\""
    m 2a "Check that all lines below 'label chapter1:' are aligned and that 'return' is the last line."
    ...
    m 3a "Let's look at 'stop music fadeout 2.0' first. Before you click New Game, you can hear the \"Doki Doki!\" music, right?"
    ...
    m 4a "The next line 'play music t2' tells the game to play the music named 't2'. You're surely wondering what 't2' is. 't2' refers to Sayori theme, 'Ohayou Sayori!'."
    ...
    m "You can find definitions.rpy inside the game folder which should be in the Mod Template's directory."
    ...
    m 1e "..."
    m 4a "The last line you wrote, 'mc 'Let's listen to the music.', makes the main character say 'Let's listen to the music.'. I'll explain how dialogue works later, so bear with me okay?"
    ...
    m 1b "Congratulations! You now know how to stop and play music~"
...
label tutorial_route_p3:
    ...
    m 1a "Last time, we added music to our mod but as you saw, the background was nothing but black and white squares."
    m 1b "So let's add a background! It's going to be quick and easy."
    m 2a "Like last time, open chapter1.rpy."
    m "Add between 'play music t2' and 'mc 'Let's listen to the music.', \"scene bg residential_day\"."
    m "Then add another line: \"with dissolve_scene_full\". Once again, verify that everything bellow 'label chapter1.rpy:' is aligned."
    m 3a "Open Ren'Py and play the game and..."
    m 3b "There's now a neat background!"
    m 5a "Can you recognize it? It's the first scene you saw when you played the game."
    m 1a "So about what you wrote, 'scene bg residential_day', the keyword 'scene' tells the game to load the scene, 'bg' tells it is a background, and 'bg residential_day', the name of the scene."
    m "You can find what exactly 'bg residential_day' is in definitions.rpy, the same script we looked at last tutorial."
    ...
    m "Go back to chapter1.rpy and replace 'scene bg residential_day' by 'scene bg sayori_bedroom'. Can you guess what happens?"
...
label tutorial_route_p4:
    ...
    m 2a "First, open chapter1.rpy and replace ' \ \ \ mc 'Let's listen to the music.' by the following line:"
    ...
    m "' \ \ \ mc 'It has been four days since I joined the Literature Club. Today is Saturday and I finally decided to confess my feeling to Monika.'."
    m "Like usual, check that chapter1.rpy is exactly like T4.rpy inside the monika_route_answer folder."
...
label tutorial_route_p5:
    ...
    m 4a "Like every time, open chapter1.rpy and between 'return' and the last line before it,-"
...
label tutorial_route_p6:
    ...
    m 2a "You know the drill, open chapter1.rpy and at the end of the file, just before 'return'..."
...
label tutorial_route_p7:
    ...
    m 4b "Let's dot it! Open chapter1.rpy and before 'return', write:"
...
label tutorial_route_p8:
    ...
    m 4a "Open chapter1.rpy and just before..."
...
label tutorial_route_p9:
    ...
    m 4a "Open chapter1.rpy and before the last 'return', jump a line and add..."
    m "' \ \ \ menu :',"
    m "' \ \ \ \ \ \ mc 'Right. Monika,...'',"
